...
import { LANGUAGE, LANGUAGE_FILES, SLIDER_SIZE, VALUE_COLOR_DENS_OBJ } from '../../Conf';
        ...
        colors.push(<span key={i}>
            ...
            { 
                ...
                <div style={ styles[i].cover } onClick={() => handleClose(self, i) }/>
                    <SketchPicker presetColors={VALUE_COLOR_DENS_OBJ['color']} disableAlpha={true} color={ self.state.options.colors[i] } onChange={(color) => handleChange(self, color, i) } />
                </div> : null 
            }
        </span>)
    }
