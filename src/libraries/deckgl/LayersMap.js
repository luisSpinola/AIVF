...
import { MAP_BEARING, MAP_LAT, MAP_LONG, MAP_PITCH, MAP_ZOOM } from '../../utils/Conf';
...
export const LayersMap = (props) => {
    ...
    if(props.type === 'column') layers.push(getColumnMapLayer(props.data, colors));
    if(props.type === 'bubble') layers.push(getBubbleMapLayer(props.data, colors)); 
    if(props.type === 'path') layers.push(getPathMapLayer(props.data, colors));
    if(props.type === 'path') layers.push(getIconMapLayer(props.data, colors));
