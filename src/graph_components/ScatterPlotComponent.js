...
import { ScatterPlot } from "../libraries/recharts/ScatterPlot";
//  Local Imports -> Utils
...
export default class ScatterPlotComponent extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            options: {
    ...
    drawerOptions = () => {
        let options = <React.Fragment key={"drawer-options"}>
                            ...
                            {getAxesOptions(this,false,false,false,true)}
                            {getLabelListOptions(this, true)}
                            {getLegendOptions(this, false)}
                            {getGridOptions(this)}
                            {getMarginOptions(this)}
                            {getColorOptions(this,this.props.data.data.length,true)}
